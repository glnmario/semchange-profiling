...
echo morphology
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus1_morph.json --input2 features/russian/corpus2_morph.json --output results/russian12_separate_${distance}_${agregate}_5 --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step
...
echo averaging
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus1_synt.json --input2 features/russian/corpus2_synt.json --output results/russian12_synt_${distance}_5 --threshold 5 --distance ${distance}
...
echo combination
    ...
    python3 -W ignore compare_ling.py --input1 features/russian/corpus1_morph.json --input2 features/russian/corpus2_morph.json --output results/russian12_separate_${distance}_${agregate}_5_added_syntax --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step --added_features1 features/russian/corpus1_synt.json --added_features2 features/russian/corpus2_synt.json
...
echo morphology
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus2_morph.json --input2 features/russian/corpus3_morph.json --output results/russian23_separate_${distance}_${agregate}_5 --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step
...
echo averaging
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus2_synt.json --input2 features/russian/corpus3_synt.json --output results/russian23_synt_${distance}_5 --threshold 5 --distance ${distance}
...
echo combination
    ...
    python3 -W ignore compare_ling.py --input1 features/russian/corpus2_morph.json --input2 features/russian/corpus3_morph.json --output results/russian23_separate_${distance}_${agregate}_5_added_syntax --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step --added_features1 features/russian/corpus2_synt.json --added_features2 features/russian/corpus3_synt.json
...
echo morphology
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus1_morph.json --input2 features/russian/corpus3_morph.json --output results/russian13_separate_${distance}_${agregate}_5 --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step
...
echo averaging
	...
	python3 -W ignore compare_ling.py --input1 features/russian/corpus1_synt.json --input2 features/russian/corpus3_synt.json --output results/russian13_synt_${distance}_5 --threshold 5 --distance ${distance}
...
echo combination
    ...
    python3 -W ignore compare_ling.py --input1 features/russian/corpus1_morph.json --input2 features/russian/corpus3_morph.json --output results/russian13_separate_${distance}_${agregate}_5_added_syntax --threshold 5 --distance ${distance} --agregate ${agregate} --separation 2step --added_features1 features/russian/corpus1_synt.json --added_features2 features/russian/corpus3_synt.json
