...
do
    ...
    python3 -W ignore compare_ling.py --input1 features/${LANG}/corpus1_reverse_synt.json --input2 features/${LANG}/corpus2_reverse_synt.json --output results/${LANG}_reverse_synt_${filtering} --filtering ${filtering}
    ...
    python3 -W ignore compare_ling.py --input1 features/${LANG}/corpus1_reverse_synt.json --input2 features/${LANG}/corpus2_reverse_synt.json --output results/${LANG}_reverse_synt_${filtering}_5 --threshold 5 --filtering ${filtering}
