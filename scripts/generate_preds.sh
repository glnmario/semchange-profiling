...
do
    python3 compare_ling.py --input1 features/${LANG}/corpus1_${feat}.json --input2 features/${LANG}/corpus2_${feat}.json --output results/${LANG}_${feat}_${THR} --threshold ${THR} --separation yes
done
